...
function bizworx_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'site_logo',
		array(
			'sanitize_callback' => 'bizworx_sanitize_image',
		)
	);
    ...
    $wp_customize->add_setting(
        'header_subtitle_1',
        array(
            'default' => __('Get some exciting features in our pro theme','bizworx'),
			'sanitize_callback' => 'wp_filter_nohtml_kses',
            'transport'         => 'postMessage'
        )
    );
    ...
    $wp_customize->add_setting(
        'banner_button_url',
        array(
            'default' => __('https://popularfx.com/themes/wordpress/corporate/bizworx_pro','bizworx'),
            'sanitize_callback' => 'esc_url_raw',
            'transport'         => 'postMessage'
        )
    );
