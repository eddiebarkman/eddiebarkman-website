...
body:before {
  ...
  content: "Error: Undefined variable: \"$grey-darker\".\A         on line 1 of C:\Users\Eddie3\Desktop\website\node_modules\bulma\sass\components\pagination.sass\A \A 1: $pagination-color: $grey-darker !default\A 2: $pagination-border-color: $grey-lighter !default\A 3: $pagination-margin: -0.25rem !default\A 4: \A 5: $pagination-hover-color: $link-hover !default\A 6: $pagination-hover-border-color: $link-hover-border !default"; }
