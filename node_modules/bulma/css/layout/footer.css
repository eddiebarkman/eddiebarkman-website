...
body:before {
  ...
  content: "Error: Undefined variable: \"$background\".\A         on line 1 of C:\Users\Eddie3\Desktop\website\node_modules\bulma\sass\layout\footer.sass\A \A 1: $footer-background-color: $background !default\A 2: \A 3: .footer\A 4:   background-color: $footer-background-color\A 5:   padding: 3rem 1.5rem 6rem"; }
